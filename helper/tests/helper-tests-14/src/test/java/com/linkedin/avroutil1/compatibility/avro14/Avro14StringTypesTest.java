...
public class Avro14StringTypesTest {
  ...
  public void testDefaultStringRepresentation() throws Exception {
    ...
    //avro 1.4 just puts Utf8s everywhere
    ...
    //does not respect logical types
    Assert.assertTrue(deserialized1.get("f3") instanceof Utf8);
    Assert.assertTrue(deserialized1.get("f4") instanceof Utf8);
    Assert.assertTrue(deserialized2.f3 instanceof Utf8);
