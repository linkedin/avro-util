...
public class DefaultsTestRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<DefaultsTestRecord> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a DefaultsTestRecord instance decoded from the given buffer
      ...
      try {
        ...
        if (oldSubRecordBuilder != null) {
          try {
            ...
            e.addParentField(record.getSchema().getField("oldSubRecord"));
            throw e;
          }
        } else {
        ...
        if (newFieldWithOldSubRecordBuilder != null) {
          try {
            ...
            e.addParentField(record.getSchema().getField("newFieldWithOldSubRecord"));
            throw e;
          }
        } else {
