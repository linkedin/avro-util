...
public class Parser {
  ...
  public interface ActionHandler {
    /**
     * Handle the action symbol {@code top} when the {@code input} is sought to be
     * taken off the stack.
     *
     * @param input The input symbol from the caller of advance
     * @param top   The symbol at the top the stack.
     * @return {@code null} if advance() is to continue processing the stack. If
     *         not {@code null} the return value will be returned by advance().
     * @throws IOException
     */
   ...
   * terminal symbol suppled {@code terminal}.
   *
  ...
  /**
   * Pushes the production for the given symbol {@code sym}. If {@code sym} is a
   * repeater and {@code input} is either {@link Symbol#ARRAY_END} or
