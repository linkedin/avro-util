...
import com.linkedin.avroutil1.compatibility.avro110.parsing.JsonGrammarGenerator;
import com.linkedin.avroutil1.compatibility.avro110.parsing.Parser;
...
public class CompatibleJsonEncoder extends ParsingEncoder implements Parser.ActionHandler {
  ...
  CompatibleJsonEncoder(Schema sc, JsonGenerator out, boolean useFqcns) throws IOException {
    configure(out);
    this.parser = new Parser(new JsonGrammarGenerator().generate(sc, useFqcns), this);
  }
   ...
   * @return this JsonEncoder
   */
  private CompatibleJsonEncoder configure(JsonGenerator generator) throws IOException {
