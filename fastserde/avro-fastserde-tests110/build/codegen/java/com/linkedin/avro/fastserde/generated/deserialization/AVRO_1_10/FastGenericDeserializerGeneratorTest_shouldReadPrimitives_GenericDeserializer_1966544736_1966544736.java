    ...
    implements FastDeserializer<IndexedRecord>
{
    ...
    public FastGenericDeserializerGeneratorTest_shouldReadPrimitives_GenericDeserializer_1966544736_1966544736(Schema readerSchema, GenericData modelData) {
        ...
        throws IOException
    {
        ...
        if ((((reuse)!= null)&&((reuse) instanceof IndexedRecord))&&(((IndexedRecord)(reuse)).getSchema() == readerSchema)) {
            ...
            FastGenericDeserializerGeneratorTest_shouldReadPrimitives = new GenericData.Record(readerSchema);
        }
        ...
        throws IOException
    {
        ...
        if (unionIndex1 == 0) {
            ...
            if (unionIndex1 == 1) {
                ...
                FastGenericDeserializerGeneratorTest_shouldReadPrimitives.put(3, charSequence1);
            } else {
        ...
        throws IOException
    {
        ...
        if (unionIndex6 == 0) {
            ...
            if (unionIndex6 == 1) {
                ...
                FastGenericDeserializerGeneratorTest_shouldReadPrimitives.put(13, byteBuffer1);
            } else {
