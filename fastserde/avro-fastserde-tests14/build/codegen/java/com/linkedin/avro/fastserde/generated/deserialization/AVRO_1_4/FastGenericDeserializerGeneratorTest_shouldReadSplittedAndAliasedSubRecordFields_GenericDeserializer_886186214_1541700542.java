...
public class FastGenericDeserializerGeneratorTest_shouldReadSplittedAndAliasedSubRecordFields_GenericDeserializer_886186214_1541700542
    implements FastDeserializer<IndexedRecord>
{
    ...
    public FastGenericDeserializerGeneratorTest_shouldReadSplittedAndAliasedSubRecordFields_GenericDeserializer_886186214_1541700542(Schema readerSchema) {
        ...
        throws IOException
    {
        ...
        if (unionIndex0 == 0) {
            ...
            if (unionIndex0 == 1) {
                ...
                aliasedSubRecord.put(1, charSequence0);
            } else {
