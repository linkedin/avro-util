...
public class FullRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2431587597188710606L;
  ...
  private static final BinaryMessageEncoder<FullRecord> ENCODER =
      new BinaryMessageEncoder<FullRecord>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<FullRecord> DECODER =
      new BinaryMessageDecoder<FullRecord>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<FullRecord> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<FullRecord> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<FullRecord> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<FullRecord>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this FullRecord to a ByteBuffer.
  ...
  /**
   * Deserializes a FullRecord from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a FullRecord instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static FullRecord fromByteBuffer(
   ...
   * @return A new FullRecord RecordBuilder
   */
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<FullRecord>
    WRITER$ = (org.apache.avro.io.DatumWriter<FullRecord>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<FullRecord>
    READER$ = (org.apache.avro.io.DatumReader<FullRecord>)MODEL$.createDatumReader(SCHEMA$);
