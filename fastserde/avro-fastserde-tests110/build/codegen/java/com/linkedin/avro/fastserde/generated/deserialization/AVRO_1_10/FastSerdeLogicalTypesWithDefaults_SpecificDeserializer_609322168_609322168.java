    ...
    implements FastDeserializer<com.linkedin.avro.fastserde.generated.avro.FastSerdeLogicalTypesWithDefaults>
{
        ...
        throws IOException
    {
        ...
        FastSerdeLogicalTypesWithDefaults.put(6, charSequence0);
    }
        ...
        throws IOException
    {
        ...
        FastSerdeLogicalTypesWithDefaults.put(7, convertedValue9);
        ...
        FastSerdeLogicalTypesWithDefaults.put(8, convertedValue10);
    }
        ...
        throws IOException
    {
        ...
        FastSerdeLogicalTypesWithDefaults.put(9, convertedValue11);
        ...
        FastSerdeLogicalTypesWithDefaults.put(10, convertedValue12);
    }
        ...
        throws IOException
    {
        ...
        FastSerdeLogicalTypesWithDefaults.put(11, convertedValue13);
        ...
        throws IOException
    {
        ...
        LocalTimestampRecordWithDefaults.put(0, convertedValue14);
        ...
        throws IOException
    {
        ...
        if (unionIndex4 == 0) {
            ...
            if (unionIndex4 == 1) {
                ...
                LocalTimestampRecordWithDefaults.put(1, convertedValue15);
            } else {
        ...
        if (unionIndex5 == 0) {
            ...
            if (unionIndex5 == 1) {
                ...
                LocalTimestampRecordWithDefaults.put(2, convertedValue16);
            } else {
                if (unionIndex5 == 2) {
        ...
        throws IOException
    {
        ...
        if (unionIndex6 == 0) {
            ...
            LocalTimestampRecordWithDefaults.put(3, convertedValue18);
        } else {
            if (unionIndex6 == 1) {
