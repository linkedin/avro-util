...
public class FastGenericDeserializerGeneratorTest_shouldReadFixed_GenericDeserializer_380547189_380547189
        ...
        throws IOException
    {
        ...
        if (unionIndex0 == 0) {
            ...
            if (unionIndex0 == 1) {
                ...
                FastGenericDeserializerGeneratorTest_shouldReadFixed.put(1, new org.apache.avro.generic.GenericData.Fixed(testFixed2));
            } else {
        ...
        while (chunkLen0 > 0) {
            for (int counter0 = 0; (counter0 <chunkLen0); counter0 ++) {
                ...
                testFixedArray1 .add(new org.apache.avro.generic.GenericData.Fixed(testFixed3));
            }
            ...
            for (int counter1 = 0; (counter1 <chunkLen1); counter1 ++) {
                ...
                if (unionIndex1 == 0) {
                    ...
                    if (unionIndex1 == 1) {
                        ...
                        testFixedUnionArray1 .add(new org.apache.avro.generic.GenericData.Fixed(testFixed4));
                    } else {
