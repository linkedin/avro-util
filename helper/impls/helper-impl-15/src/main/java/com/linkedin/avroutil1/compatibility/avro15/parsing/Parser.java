 ...
 */
package com.linkedin.avroutil1.compatibility.avro15.parsing;
...
public class Parser {
  ...
  public interface ActionHandler {
    /**
     * Handle the action symbol {@code top} when the {@code input} is
     ...
     * @return  {@code null} if advance() is to continue processing the
     * stack. If not {@code null} the return value will be returned
     * by advance().
     * @throws IOException
     */
   ...
   * top symbol matches the terminal symbol suppled {@code terminal}.
  ...
  /**
   * Pushes the production for the given symbol {@code sym}.
   * If {@code sym} is a repeater and {@code input} is either
