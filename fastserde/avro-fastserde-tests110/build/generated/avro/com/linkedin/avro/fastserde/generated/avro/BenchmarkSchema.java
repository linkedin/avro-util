...
public class BenchmarkSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<BenchmarkSchema> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a BenchmarkSchema instance decoded from the given buffer
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (java.lang.Double e0: this.testArray) {
      actualSize0++;
      out.startItem();
      out.writeDouble(e0);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<java.lang.Double> a0 = this.testArray;
      if (a0 == null) {
        a0 = new SpecificData.Array<java.lang.Double>((int)size0, SCHEMA$.getField("testArray").schema());
        this.testArray = a0;
      } else a0.clear();
