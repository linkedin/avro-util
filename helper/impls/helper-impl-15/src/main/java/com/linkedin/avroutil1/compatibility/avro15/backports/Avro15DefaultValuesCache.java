...
import com.linkedin.avroutil1.compatibility.avro15.Avro15SchemaValidator;
...
import org.apache.avro.io.parsing.Avro15ResolvingGrammarGeneratorAccessUtil;
 ...
 */
public class Avro15DefaultValuesCache {
  ...
  public static Object getDefaultValue(Schema.Field field, boolean specific) {
    ...
    try {
      ...
      Avro15ResolvingGrammarGeneratorAccessUtil.encode(encoder, schema, json);
      encoder.flush();
