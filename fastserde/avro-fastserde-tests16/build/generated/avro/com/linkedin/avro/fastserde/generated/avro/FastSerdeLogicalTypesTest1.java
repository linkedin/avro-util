  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FastSerdeLogicalTypesTest1>
    ...
    private Builder(com.linkedin.avro.fastserde.generated.avro.FastSerdeLogicalTypesTest1 other) {
      ...
      if (isValidValue(fields()[1], other.timestampMillisMap)) {
        this.timestampMillisMap = (java.util.Map<java.lang.CharSequence,java.lang.Long>) data().deepCopy(fields()[1].schema(), other.timestampMillisMap);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], other.nullableArrayOfDates)) {
        this.nullableArrayOfDates = (java.util.List<java.lang.Integer>) data().deepCopy(fields()[2].schema(), other.nullableArrayOfDates);
        fieldSetFlags()[2] = true;
      }
      if (isValidValue(fields()[3], other.arrayOfDates)) {
        this.arrayOfDates = (java.util.List<java.lang.Integer>) data().deepCopy(fields()[3].schema(), other.arrayOfDates);
        fieldSetFlags()[3] = true;
      }
      if (isValidValue(fields()[4], other.unionOfDecimalOrDate)) {
        this.unionOfDecimalOrDate = (java.lang.Object) data().deepCopy(fields()[4].schema(), other.unionOfDecimalOrDate);
        fieldSetFlags()[4] = true;
      }
      if (isValidValue(fields()[5], other.uuidField)) {
        this.uuidField = (java.lang.CharSequence) data().deepCopy(fields()[5].schema(), other.uuidField);
        fieldSetFlags()[5] = true;
      }
      if (isValidValue(fields()[6], other.timestampMillisField)) {
        this.timestampMillisField = (java.lang.Long) data().deepCopy(fields()[6].schema(), other.timestampMillisField);
        fieldSetFlags()[6] = true;
      }
      if (isValidValue(fields()[7], other.timestampMicrosField)) {
        this.timestampMicrosField = (java.lang.Long) data().deepCopy(fields()[7].schema(), other.timestampMicrosField);
        fieldSetFlags()[7] = true;
      }
      if (isValidValue(fields()[8], other.timeMillisField)) {
        this.timeMillisField = (java.lang.Integer) data().deepCopy(fields()[8].schema(), other.timeMillisField);
        fieldSetFlags()[8] = true;
      }
      if (isValidValue(fields()[9], other.timeMicrosField)) {
        this.timeMicrosField = (java.lang.Long) data().deepCopy(fields()[9].schema(), other.timeMicrosField);
        fieldSetFlags()[9] = true;
      }
      if (isValidValue(fields()[10], other.dateField)) {
        this.dateField = (java.lang.Integer) data().deepCopy(fields()[10].schema(), other.dateField);
        fieldSetFlags()[10] = true;
      }
      if (isValidValue(fields()[11], other.nestedLocalTimestampMillis)) {
        this.nestedLocalTimestampMillis = (com.linkedin.avro.fastserde.generated.avro.LocalTimestampRecord) data().deepCopy(fields()[11].schema(), other.nestedLocalTimestampMillis);
