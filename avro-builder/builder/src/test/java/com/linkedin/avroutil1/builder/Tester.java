...
//    Assert.assertEquals(javaFiles.size(), 1);
    ...
    SpamUser spamUser2 = AvroRecordUtil.genericRecordToSpecificRecord(genericRecord, null, new RecordConversionConfig(true, true, true, false, StringRepresentation.Utf8, true));
