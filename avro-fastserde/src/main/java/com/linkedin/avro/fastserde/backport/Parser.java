...
public class Parser {
  ...
  public interface ActionHandler {
     ...
     * @return  null if advance() is to continue processing the
   ...
   * If sym is a repeater and input is either
  ...
  /**
   * @return Pops and returns the top symbol from the stack.
   */
  ...
  /**
   * @return Returns the top symbol from the stack.
   */
  ...
  /**
   * @param sym Pushes sym on to the stack.
   */
  ...
  /**
   * @return Returns the depth of the stack.
   */
  public int depth() {
    return pos;
  }
