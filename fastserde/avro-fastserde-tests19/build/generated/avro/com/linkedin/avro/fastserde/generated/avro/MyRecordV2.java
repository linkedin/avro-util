...
public class MyRecordV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<MyRecordV2> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a MyRecordV2 instance decoded from the given buffer
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.enumField = com.linkedin.avro.fastserde.generated.avro.MyEnumV2.values()[in.readEnum()];
