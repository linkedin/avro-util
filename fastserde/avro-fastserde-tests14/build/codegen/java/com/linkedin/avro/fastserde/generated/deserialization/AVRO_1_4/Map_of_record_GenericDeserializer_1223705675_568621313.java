    ...
    implements FastDeserializer<Map<Utf8, IndexedRecord>>
{
        ...
        throws IOException
    {
        ...
        if (unionIndex0 == 0) {
            throw new AvroTypeException("Found \"null\", expecting {\"type\":\"map\",\"values\":{\"type\":\"record\",\"name\":\"record\",\"namespace\":\"com.linkedin.avro.fastserde.generated.avro\",\"fields\":[{\"name\":\"someInt\",\"type\":\"int\",\"doc\":\"\"}]}}");
        } else {
            if (unionIndex0 == 1) {
