...
public class GenericRecordBuilderUsageDetectorTest {
    @Rule
    public SpotBugsRule spotbugs = new SpotBugsRule();

    @Ignore //can only be run if test are compiled against avro 1.6+
    @Test
    public void testBadCase() {
        ...
        BugInstanceMatcher bugTypeMatcher = new BugInstanceMatcherBuilder()
                .bugType("GENERICRECORDBUILDER_USAGE")
                .inMethod("genericRecordBuilderUsage").build();
        MatcherAssert.assertThat(bugCollection, containsExactly(5, bugTypeMatcher));
    }
