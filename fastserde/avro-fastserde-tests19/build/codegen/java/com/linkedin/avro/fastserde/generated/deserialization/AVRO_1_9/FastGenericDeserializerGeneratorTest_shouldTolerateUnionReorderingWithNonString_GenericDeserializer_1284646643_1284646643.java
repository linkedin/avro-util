...
public class FastGenericDeserializerGeneratorTest_shouldTolerateUnionReorderingWithNonString_GenericDeserializer_1284646643_1284646643
    implements FastDeserializer<IndexedRecord>
{
    ...
    public FastGenericDeserializerGeneratorTest_shouldTolerateUnionReorderingWithNonString_GenericDeserializer_1284646643_1284646643(Schema readerSchema, GenericData modelData) {
        ...
        throws IOException
    {
        ...
        if ((((reuse)!= null)&&((reuse) instanceof IndexedRecord))&&(((IndexedRecord)(reuse)).getSchema() == readerSchema)) {
            ...
            FastGenericDeserializerGeneratorTest_shouldTolerateUnionReorderingWithNonString = new GenericData.Record(readerSchema);
        }
