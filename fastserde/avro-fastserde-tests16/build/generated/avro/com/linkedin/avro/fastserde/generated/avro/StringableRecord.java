...
public class StringableRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.lang.CharSequence biginteger;
  @Deprecated public java.lang.CharSequence bigdecimal;
  @Deprecated public java.lang.CharSequence uri;
  @Deprecated public java.lang.CharSequence url;
  @Deprecated public java.lang.CharSequence file;
  @Deprecated public java.util.List<java.lang.CharSequence> urlArray;
  @Deprecated public java.util.Map<java.lang.CharSequence,java.lang.CharSequence> urlMap;
   ...
   */
  public java.lang.CharSequence getBiginteger() {
    return biginteger;
  }
   ...
   */
  public void setBiginteger(java.lang.CharSequence value) {
   ...
   */
  public java.lang.CharSequence getBigdecimal() {
    return bigdecimal;
  }
   ...
   * @param value the value to set.
   */
  public void setBigdecimal(java.lang.CharSequence value) {
   ...
   */
  public java.util.List<java.lang.CharSequence> getUrlArray() {
    return urlArray;
  }
   ...
   * @param value the value to set.
   */
  public void setUrlArray(java.util.List<java.lang.CharSequence> value) {
    this.urlArray = value;
  }
   ...
   */
  public java.util.Map<java.lang.CharSequence,java.lang.CharSequence> getUrlMap() {
    return urlMap;
  }
   ...
   * @param value the value to set.
   */
  public void setUrlMap(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    this.urlMap = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringableRecord>
    ...
    private java.lang.CharSequence biginteger;
    private java.lang.CharSequence bigdecimal;
    private java.lang.CharSequence uri;
    private java.lang.CharSequence url;
    private java.lang.CharSequence file;
    private java.util.List<java.lang.CharSequence> urlArray;
    private java.util.Map<java.lang.CharSequence,java.lang.CharSequence> urlMap;
    ...
    private Builder(com.linkedin.avro.fastserde.generated.avro.StringableRecord other) {
      ...
      if (isValidValue(fields()[0], other.biginteger)) {
        this.biginteger = (java.lang.CharSequence) data().deepCopy(fields()[0].schema(), other.biginteger);
        fieldSetFlags()[0] = true;
      }
      if (isValidValue(fields()[1], other.bigdecimal)) {
        this.bigdecimal = (java.lang.CharSequence) data().deepCopy(fields()[1].schema(), other.bigdecimal);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], other.uri)) {
        this.uri = (java.lang.CharSequence) data().deepCopy(fields()[2].schema(), other.uri);
        fieldSetFlags()[2] = true;
      }
      if (isValidValue(fields()[3], other.url)) {
        this.url = (java.lang.CharSequence) data().deepCopy(fields()[3].schema(), other.url);
        fieldSetFlags()[3] = true;
      }
      if (isValidValue(fields()[4], other.file)) {
        this.file = (java.lang.CharSequence) data().deepCopy(fields()[4].schema(), other.file);
        fieldSetFlags()[4] = true;
      }
      if (isValidValue(fields()[5], other.urlArray)) {
        this.urlArray = (java.util.List<java.lang.CharSequence>) data().deepCopy(fields()[5].schema(), other.urlArray);
        fieldSetFlags()[5] = true;
      }
      if (isValidValue(fields()[6], other.urlMap)) {
        this.urlMap = (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>) data().deepCopy(fields()[6].schema(), other.urlMap);
        fieldSetFlags()[6] = true;
      }
      if (isValidValue(fields()[7], other.subRecord)) {
        this.subRecord = (com.linkedin.avro.fastserde.generated.avro.StringableSubRecord) data().deepCopy(fields()[7].schema(), other.subRecord);
        fieldSetFlags()[7] = true;
      }
      if (isValidValue(fields()[8], other.subRecordWithSubRecord)) {
        this.subRecordWithSubRecord = (com.linkedin.avro.fastserde.generated.avro.AnotherSubRecord) data().deepCopy(fields()[8].schema(), other.subRecordWithSubRecord);
        fieldSetFlags()[8] = true;
      }
      if (isValidValue(fields()[9], other.stringUnion)) {
        this.stringUnion = (java.lang.CharSequence) data().deepCopy(fields()[9].schema(), other.stringUnion);
    ...
    /** Sets the value of the 'biginteger' field */
    public com.linkedin.avro.fastserde.generated.avro.StringableRecord.Builder setBiginteger(java.lang.CharSequence value) {
    ...
    /** Sets the value of the 'bigdecimal' field */
    public com.linkedin.avro.fastserde.generated.avro.StringableRecord.Builder setBigdecimal(java.lang.CharSequence value) {
    ...
    /** Sets the value of the 'uri' field */
    public com.linkedin.avro.fastserde.generated.avro.StringableRecord.Builder setUri(java.lang.CharSequence value) {
    ...
    /** Sets the value of the 'url' field */
    public com.linkedin.avro.fastserde.generated.avro.StringableRecord.Builder setUrl(java.lang.CharSequence value) {
    ...
    /** Sets the value of the 'file' field */
    public com.linkedin.avro.fastserde.generated.avro.StringableRecord.Builder setFile(java.lang.CharSequence value) {
    ...
    /** Sets the value of the 'urlArray' field */
    public com.linkedin.avro.fastserde.generated.avro.StringableRecord.Builder setUrlArray(java.util.List<java.lang.CharSequence> value) {
    ...
    /** Sets the value of the 'urlMap' field */
    public com.linkedin.avro.fastserde.generated.avro.StringableRecord.Builder setUrlMap(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public StringableRecord build() {
      try {
        ...
        record.biginteger = fieldSetFlags()[0] ? this.biginteger : (java.lang.CharSequence) defaultValue(fields()[0]);
        record.bigdecimal = fieldSetFlags()[1] ? this.bigdecimal : (java.lang.CharSequence) defaultValue(fields()[1]);
        ...
        record.file = fieldSetFlags()[4] ? this.file : (java.lang.CharSequence) defaultValue(fields()[4]);
        record.urlArray = fieldSetFlags()[5] ? this.urlArray : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[5]);
        record.urlMap = fieldSetFlags()[6] ? this.urlMap : (java.util.Map<java.lang.CharSequence,java.lang.CharSequence>) defaultValue(fields()[6]);
