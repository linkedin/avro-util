 ...
 */
public class CompatibleJsonDecoder extends ParsingDecoder implements Parser.ActionHandler {
   ...
   */
  public CompatibleJsonDecoder configure(InputStream in) throws IOException {
   ...
   * @return this JsonDecoder
   */
  public CompatibleJsonDecoder configure(String in) throws IOException {
