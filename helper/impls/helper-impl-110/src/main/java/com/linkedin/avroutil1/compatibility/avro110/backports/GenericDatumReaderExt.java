...
package com.linkedin.avroutil1.compatibility.avro110.backports;
...
public class GenericDatumReaderExt<T> extends GenericDatumReader<T> {
    ...
    private Object readRecord(Object old, Schema expected,
        ...
        Object state = Avro110GenericDataAccessUtil.getRecordState(data, r, expected);
        ...
        for (Schema.Field f : in.readFieldOrder()) {
            ...
            if (old != null) {
                oldDatum = Avro110GenericDataAccessUtil.getField(data, r, name, pos, state);
            }
            Avro110GenericDataAccessUtil.setField(getData(), r, f.name(), f.pos(),
