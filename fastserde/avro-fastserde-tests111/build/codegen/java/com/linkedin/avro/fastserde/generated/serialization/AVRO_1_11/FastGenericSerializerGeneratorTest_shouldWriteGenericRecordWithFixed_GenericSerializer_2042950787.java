    ...
    implements FastSerializer<IndexedRecord>
{
        ...
        throws IOException
    {
        ...
        if (testFixedUnion0 == null) {
            ...
            if ((testFixedUnion0 instanceof GenericFixed)&&"com.adpilot.utils.generated.avro.testFixed".equals(((GenericFixed) testFixedUnion0).getSchema().getFullName())) {
        ...
        if ((testFixedUnionArray0 == null)||testFixedUnionArray0 .isEmpty()) {
            ...
            for (int counter1 = 0; (counter1 <testFixedUnionArray0 .size()); counter1 ++) {
                ...
                if (union0 == null) {
                    ...
                    if ((union0 instanceof GenericFixed)&&"com.adpilot.utils.generated.avro.testFixed".equals(((GenericFixed) union0).getSchema().getFullName())) {
                        (encoder).writeIndex(1);
