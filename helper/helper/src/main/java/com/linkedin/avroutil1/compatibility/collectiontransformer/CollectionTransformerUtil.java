...
public class CollectionTransformerUtil {
  ...
  /**
   * Returns a {@StringListView} for the given list of {@Utf8} objects.
   * @param utf8List list of {@Utf8} objects
   * @return a {@StringListView} for the given list of {@Utf8} objects
   */
  ...
  /**
   * Returns a {@CharSequenceListView} for the given list of {@Utf8} objects.
   * @param utf8List list of {@Utf8} objects
   * @return a {@CharSequenceListView} for the given list of {@Utf8} objects
   */
  ...
  /**
   * Returns a {@Utf8ListView} for the given list of {@Utf8} objects.
   * @param utf8List list of {@Utf8} objects
   * @return a {@Utf8ListView} for the given list of {@Utf8} objects
   */
  ...
  /**
   * Returns a {@StringMapView} for the given map of {@Utf8} objects.
   * @param utf8Map map of {@Utf8} objects
   * @return a {@StringMapView} for the given map of {@Utf8} objects
   */
  ...
  /**
   * Returns a {@CharSequenceMapView} for the given map of {@Utf8} objects.
   * @param utf8Map map of {@Utf8} objects
   * @return a {@CharSequenceMapView} for the given map of {@Utf8} objects
   */
