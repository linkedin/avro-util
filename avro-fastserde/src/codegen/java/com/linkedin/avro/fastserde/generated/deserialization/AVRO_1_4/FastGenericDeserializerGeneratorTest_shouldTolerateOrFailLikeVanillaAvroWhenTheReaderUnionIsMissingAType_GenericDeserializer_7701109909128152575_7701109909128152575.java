...
public class FastGenericDeserializerGeneratorTest_shouldTolerateOrFailLikeVanillaAvroWhenTheReaderUnionIsMissingAType_GenericDeserializer_7701109909128152575_7701109909128152575
    implements FastDeserializer<IndexedRecord>
{
    ...
    public FastGenericDeserializerGeneratorTest_shouldTolerateOrFailLikeVanillaAvroWhenTheReaderUnionIsMissingAType_GenericDeserializer_7701109909128152575_7701109909128152575(Schema readerSchema) {
        ...
        throws IOException
    {
        ...
        if (unionIndex0 == 0) {
            ...
            if (unionIndex0 == 1) {
                if (FastGenericDeserializerGeneratorTest_shouldTolerateOrFailLikeVanillaAvroWhenTheReaderUnionIsMissingAType.get(0) instanceof Utf8) {
                    FastGenericDeserializerGeneratorTest_shouldTolerateOrFailLikeVanillaAvroWhenTheReaderUnionIsMissingAType.put(0, (decoder).readString(((Utf8) FastGenericDeserializerGeneratorTest_shouldTolerateOrFailLikeVanillaAvroWhenTheReaderUnionIsMissingAType.get(0))));
                } else {
